...
- **Repository path:** `/todd-test`
- **Open PRs (search):** https://github.com/ORG/REPO/pulls?q=is%3Apr+todd-test
...
|---|---|---|
| Dev | https://todd-test.dev.example.com | _(replace with your real dev domain)_ |
| Staging | https://todd-test.stg.example.com |  |
| Prod | https://todd-test.example.com |  |

> If you don’t have ingress yet, you can still access a running pod locally:
>
> ```bash
> # Example: adjust namespace/service as needed
> kubectl port-forward -n <namespace> svc/todd-test-web 5173:80
...
- **Branching:** feature branches like `feature/todd-test-<run-number>`
