...
> **Folder:** `/todd-test-six`  
> **IDP Identifier:** `todd_test_six`

---

## Quick links

- **Repository path:** `/todd-test-six`
- **Open PRs (search):** https://github.com/harness-idp-sandbox/harness-monorepo/pulls?q=is%3Apr+todd-test-six+label%3Aidp+label%3Ascaffold+sort%3Acreated-desc
...
|---|---|---|
| Dev | https://todd-test-six.dev.example.com | _(replace with your real dev domain)_ |
| Staging | https://todd-test-six.stg.example.com |  |
| Prod | https://todd-test-six.example.com |  |

> No ingress yet? Port-forward locally:
>
> ```bash
> # Example: adjust namespace/service as needed
> kubectl port-forward -n <namespace> svc/todd-test-six-web 5173:80
...
- **Branching:** The pipeline creates feature branches like `feature/todd-test-six-<run-number>`.
...
- **Descriptor location:** `todd-test-six/catalog-info.yaml`  
